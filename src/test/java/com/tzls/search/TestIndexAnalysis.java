...
public class TestIndexAnalysis {
	...
	public TestIndexAnalysis(String value){
		this.input = value;
	}
	
	@Parameters
	public static Collection paramter(){
		return Arrays.asList(new String[]{"我 的确实在无聊"},new String[]{"上海小南国国际饭店"},new String[]{"上(海)(hilton)"},new String[]{"北京大学"},new String[]{"WI-fi"});
	}
	...
	@Test
	public void test(){
		List<Term> terms = IndexAnalysis.parse(input);
		for(Term term : terms){
